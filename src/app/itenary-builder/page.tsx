            ...
            {selectedDay === 0 ? (
              <div className="flex flex-col space-y-10 w-full">
                <div>
                  ...
                  <div className="flex cursor-pointer space-x-3  bg-gray-200/70 w-[50%] justify-center items-center">
                    <AttachFileIcon
                      fontSize="small"
                ...
                <div className="w-[60%] space-y-10">
                  <div>
                    <h2 className="text-black font-bold wider mb-2">
                      Company Name
                    </h2>
                    <TextField
                      id="outlined"
                  ...
                  <div>
                    <h2 className="text-black text-lg font-[600] wider">
                      Title
                    </h2>
                    <TextField
