...
const Menu = React.forwardRef(function Menu(
  ...
  return (
    <Popper open={open} anchorEl={triggerElement}>
      <ul className="menu-root" {...other} {...getListboxProps()} style={{marginTop:20}}>
...
const MenuItem = React.forwardRef(function MenuItem(
  ...
  return (
    <li
      ...
      className={`min-w-20 ${clsx(classes)}`}
    >
      {children}
    </li>
  );
...
const MenuButton = React.forwardRef(function MenuButton(
  ...
  return (
    <div {...props} {...getButtonProps()} />
  );
});

export default function CustomMenu({children,menuItems,onClick}:{onClick:any,children:any,menuItems:{title:string,link?:string}[]}) {
  ...
  return (
    <React.Fragment>
      ...
      <MenuButton> {children}</MenuButton>  
        ...
        <h2 className=" text-[#191919ee]"> {menu.title}</h2>
          </MenuItem>)}
        </Menu>
